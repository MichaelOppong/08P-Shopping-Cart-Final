...
$(".newItem").click(function(){
    ...
    TotalPrice=0;
    $(".cart").append("<div class='item'><img src="+images+"><p>"+name+"</p><p>$"+price+"</p><div class='cartItem'></div></div>");
...
$(".purchase").click(function(){
   alert("Your total is $"+TotalPrice+". Thanks for purchasing "+itemNames[0] +" and all your other items!");
